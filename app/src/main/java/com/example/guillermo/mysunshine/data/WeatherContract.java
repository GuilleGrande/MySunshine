 ...
 */
package com.example.guillermo.mysunshine.data;
...
public class WeatherContract
{
    ...
    public static final String CONTENT_AUTHORITY = "com.example.guillermo.mysunshine.app";
    //We use CONTENT_AUTHORITY as base for the URI
    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    //Possible path for URI build
    ...
    public static final class LocationEntry implements BaseColumns
    {
        ...
        //String to send to OpenWeatherMap as the location query
        public static final String COLUMN_LOCATION_SETTING = "location_setting";

        //String representing the human friendly lacation name
        public static final String COLUMN_CITY_NAME = "city_name";

        //Coordinates to store pin point location

...
public class WeatherProvider extends ContentProvider
{
    ...
    public static UriMatcher buildUriMatcher()
    {
        ...
        // For each type of URI you want to add, create a corresponding code. Use the constants from
    ...
    {
        // We start by getting a writable database
        final SQLiteDatabase db = mOpenHelper.getWritableDatabase();
        // We use the uriMatcher to match the WEATHER and LOCATION URI's we are going to

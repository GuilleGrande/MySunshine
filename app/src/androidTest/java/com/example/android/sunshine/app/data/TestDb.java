...
import com.example.guillermo.mysunshine.data.WeatherDbHelper;
...
public class TestDb extends AndroidTestCase
{
    ...
    */
    ...
    public void testWeatherTable()
    {
        ...
        assertTrue("Error: No records returned form location query", c.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("testInsertReadDb weatherEntry failed to validate", c, weatherValues);
    ...
    public long insertLocation()
    {
        ...
        // Insert ContentValues into database and verify that we get a row ID back
